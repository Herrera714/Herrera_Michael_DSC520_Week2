...
## Use 'setwd()' if needed
setwd("/Users/714Mi/Documents/Assignment02")

## Load the file 'data/tidynomicon/person.csv' to 'person_df1' using 'read.csv'
## Examine the structure of 'person_df1' using 'str()'
person_df1 <- read.csv("/Users/714Mi/Documents/Assignment02/data/tidynomicon/person.csv")
str(person_df1)
...
person_df2 <- read.csv("/Users/714Mi/Documents/Assignment02/data/tidynomicon/person.csv", stringsAsFactors = FALSE)
str(person_df2)


## Read the file 'data/scores.csv' to 'scores_df'
## Display summary statistics using the 'summary()' function
scores_df <- read.csv("/Users/714Mi/Documents/Assignment02/data/scores.csv")
summary(scores_df)

## load the 'readxl' library
library(readxl)

## Using the excel_sheets() function from the 'readx1' package,
## list the worksheets from the file 'data/G04ResultsDetail2004-11-02.xls'

excel_sheets("/Users/714Mi/Documents/Assignment02/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("/Users/714Mi/Documents/Assignment02/data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 1")
str(voter_turnout_df1)

## Using the 'read.excel()' function, read the Voter Turnout sheet
...
## Examine the structure of 'voter_turnout_df2'
voter_turnout_df2 <- read_excel("("/Users/714Mi/Documents/Assignment02/data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", skip = 1")

colnames(voter_turnout_df2) <- c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout", skip = 1)
...
db <- dbConnect(RSQLite::SQLite(), dbname = "/Users/714Mi/Documents/Assignment02/data/tidynomicon/example.db)
...
## Covert the scores dataframe to JSON using the 'toJSON()' function with the 'pretty=TRUE' option
