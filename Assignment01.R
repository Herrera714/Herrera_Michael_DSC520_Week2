...
week1_weekdays <- week1_sleep[2:6]
...
## See if weekdays1_mean is greater than weekdasy2_mean using the '>' operator
...
students_combined <- matrix(c(student01, student02, student03), nrow = 3, ncol = 2)
